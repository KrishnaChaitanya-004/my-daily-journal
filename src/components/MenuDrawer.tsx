import { Image, Bookmark, Settings, Home, Search, BarChart3, CheckSquare, Tag, Mic, MapPin, Trophy, Timer, ScrollText, ListTodo } from 'lucide-react';
...
const allMenuItems = [
  ...
  { icon: ListTodo, label: 'Tasks', path: '/tasks', settingKey: null },
