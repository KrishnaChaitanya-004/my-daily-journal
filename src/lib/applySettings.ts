...
// This ensures fonts and theme are applied before first render on Android
...
export const applySettingsImmediately = () => {
  try {
    ...
    root.style.setProperty(
      ...
      settings.calendarSelectionColor === 'auto'
        ? primaryHsl
        : hexToHsl(settings.calendarSelectionColor || '#3b82f6')
    );
